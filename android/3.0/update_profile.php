<?php
	...
	if ($_SERVER['REQUEST_METHOD']=='POST') {
		...
		$newusercerita = mysqli_real_escape_string($connection, $_POST['newusercerita']);
		$newuseravatar = mysqli_real_escape_string($connection, $_POST['newuseravatar']);
		$newusernotification = mysqli_real_escape_string($connection, $_POST['newusernotification']);
		...
		if ($newuseravatar == "") {
			$SQL = "UPDATE akun SET user_nama='$newusernama', user_cerita='$newusercerita', user_notification='$newusernotification' WHERE user_id='$userid';";
			$ind['upload'] = "0";
		} else {
			$SQL = "UPDATE akun SET user_nama='$newusernama', user_cerita='$newusercerita', user_notification='$newusernotification', user_avatar='$newuseravatar' WHERE user_id='$userid';";
			$ind['upload'] = "1";
		}

	...
	<div class="container-fluid">
	  <div class="row">
	    ...
	    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
	    	<div class="mt-4">
	    		<h3>Selamat Datang di <?php echo $sekolah_nama;?></h3>
	    		<a href="paket"><button class="btn btn-primary mt-4">Lihat Paket <span class="fa fa-arrow-right animated wobble infinite slower"></span></button></a>
	    	</div>
	    </main>

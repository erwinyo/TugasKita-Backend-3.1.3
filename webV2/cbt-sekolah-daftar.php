      ...
      <h1><span class="text-tugaskita">TugasKita</span> <small class="text-info">sekolah</small></h1>
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-4">
				<form action="sistem/register_sekolah" method="POST">
        	...
        	<div class="form-group animated fadeInUp delay-1s faster">
      		...
      		<input type="hidden" name="type" value="cbt-sekolah"><br>
    			<button class="btn btn-primary animated fadeInUp delay-1s faster" type="submit" name="submit">Daftarkan Sekolah</button>
    		</form>
        <div class="text-center mt-4 animated fadeInUp delay-2s faster">
          <a href="cbt-sekolah"><small>sudah punya akun sekolah? login disini</small></a>
        </div>
			</div>
			<div class="col-md-4 col-sm-4"></div>
		</div><br><br><br>

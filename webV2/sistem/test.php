<html lang="en">
  ...
  <body>
      ...
      <div class="card">
        <div class="card-body">
          <span id="sambutan">Terima kasih telah mengikuti TugasKita CBTL paket 'SOSIOLOGI KELAS 11'. Anda mendapatkan nilai: <u>90</u></span><br>
        </div>
        <div class="card-footer text-right">
          <span>TugasKita Indonesia</span>
        </div>
      </div>

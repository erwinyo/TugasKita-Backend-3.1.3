		...
		<form method="POST" action="sistem/load_tugas">
			<?php
				for ($i=0;$i<count($data->grup);$i++) {
					...
					echo "<button class='btn btn-primary' name='grupid' type='submit' value='".$grupid."'>".$grupnama."</button><br>";
				}
			?>
		</form>
	</div>
	...
	<?php
		...
		<div>
			<table class="table">
				...
				<tbody>
					';
					for ($i=0;$i<count($tommorow);$i++) { 
							$author = $tommorow[$i]->tugasauthornama;
							$matapelajaran = $tommorow[$i]->tugaspelajaran;
							$nama = $tommorow[$i]->tugasnama;
							$tugaswaktu = $tommorow[$i]->tugaswaktu_harilagi;
							$tugascerita = $tommorow[$i]->tugascerita;
							$tugasprioritas = $tommorow[$i]->tugasprioritas;
							if ($tugascerita == "") {
								$tugascerita = "tugas ini tidak memiliki penjelasan...";
							}
			...
			<table class="table">
				...
				<tbody>
					...
					for ($i=0;$i<count($other);$i++) { 
							$author = $other[$i]->tugasauthornama;
							$matapelajaran = $other[$i]->tugaspelajaran;
							$nama = $other[$i]->tugasnama;
							$tugaswaktu = $other[$i]->tugaswaktu_harilagi;
							$tugascerita = $other[$i]->tugascerita;
							$tugasprioritas = $other[$i]->tugasprioritas;
							if ($tugascerita == "") {
								$tugascerita = "tugas ini tidak memiliki penjelasan...";
							}
							echo '<tr>
